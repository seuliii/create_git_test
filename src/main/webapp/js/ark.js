...
//var arkImgPath = sessionStorage.getItem("contextpath");						// 자동완성 경로
var arkImgPath = "";
//var transURL = arkPath + "search_ark.do";		// trans 페이지의 URL을 설정한다.*/
var tempQuery = "";
...
if (agent.indexOf("msie") != -1) {
	reg = /msie (\S+)/;
	browser = "IE";
	browserVersion = reg.exec(agent)[1];
...
var arkLeft = 15;								// 자동완성 왼쪽에서의 위치 값을 설정한다.
...
function drawArk() {
	...
	str = "<div id=\"" + arkDownId + "\"style=\"position:absolute; display:block; cursor:pointer; top:-22px; right:0px;\"><img id=\"" + imgDownId + "\" src=\"" + arkImgPath + "images/arrow_auto.gif\" alt=\"자동완성펼치기\"></div>";
	str += "<div id=\"" + arkUpId + "\" style=\"position:absolute; display:none; cursor:pointer; top:-22px; right:0px;\"><img id=\"" + imgUpId + "\" src=\"" + arkImgPath + "images/arrow_auto2.gif\" alt=\"자동완성접기\" ></div>";
	
	// 툴팁 이미지 생성
	//str += "<div id=\"tooltip01\" style=\"position:absolute; display:none; cursor:pointer; z-index:999999;\"><img id=\"tooltipIcon01\" src=\"" + arkImgPath +"/img/tooltip_01.gif\"/></div>";

	// 자동완성 결과 생성
	str += "<div class=\"ark_wrap\" id=\"" + wrapId +"\" style=\"position:absolute; top:-0px; left:0px; width:328px;\">";
	str += "	<ul>";
	str += "		<li class=\"ark_content\" >";
	str += "			<ul class=\"fl\" id=\"" + contentListId + "\" style=\"width:328px;\"></ul>";
	str += "		</li>";
	str += "		<li class=\"ark_footer\" id=\"" + footerId +"\" style=\"width:328px;\"></li>";
	str += "	</ul>";
	str += "</div>";
	/*
// 자동완성 접기/펼침 이미지 생성
	str = "<div id=\"" + arkDownId + "\" style=\"position:absolute; display:block; cursor:pointer;\"><img id=\"" + imgDownId + "\" src=\"" + arkImgPath + "/img/arrow_auto.gif\" alt=\"자동완성펼치기\"></div>";
	str += "<div id=\"" + arkUpId + "\" style=\"position:absolute; display:none; cursor:pointer;\"><img id=\"" + imgUpId + "\" src=\"" + arkImgPath + "/img/arrow_auto2.gif\" alt=\"자동완성접기\" ></div>";
	...
	if (isArk) {
		...
		if ($(queryId).val() != "" && isListShow) {
			...
			//$("body").append("<span style=\"display:none;\"><div id=\"tooltip02\" style=\"position:absolute;\"><img id=\"tooltipIcon02\" src=\"" + arkPath +"/img/tooltip_02.gif\"/></div></span>");
            	$("body").append("<span style=\"display:none;\"><div id=\"tooltip02\" style=\"position:absolute;\"><img id=\"tooltipIcon02\" src=\"" + arkImgPath +"images/tooltip_02.gif\"/></div></span>");
		} else {
